...
var ShapeShift = (function() {
  ...
  function CreateXmlHttp() {
    ...
    if (window.XMLHttpRequest) {
      ...
      // code for IE6, IE5
      // xmlhttp = new ActiveXObject("Microsoft.XMLHTTP"); //es-lint-disable-line
    }
    return xmlhttp;
  }
  ...
  function AjaxRequest(xmlhttp, apiEp, data, cb) {
    ...
    var url = "https://cors.shapeshift.io/" + apiEp.path;
  ...
  SS.ValidateAddress = function(address, coinSymbol, cb) {
    if (address === undefined) throw new Error("no address provided");
  ...
  SS.CreateNormalTx = function(withdrawalAddress, refundAddress, coin1, coin2) {
    var NormalTx = {
